    ...
    <div class="panel panel-default">
		...
		<div class="tab-content">
		  ...
		  <div id="menu1" class="tab-pane fade">
    				<h4>Current amount o' doubloons here: ${Plunder}</h4>
    				<br>
    				<h4>Add ye plunder here:
    				<br> 
    					<form action="http://localhost:50508/WebService1.asmx?op=Divide" method="get">
